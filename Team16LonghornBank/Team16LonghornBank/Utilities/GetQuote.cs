        ...
        public static StockQuote GetStock(string symbol)
        {
            ...
            try
            {
                ...
                using (StreamReader stReader = new StreamReader(response.GetResponseStream()))
                {
                    ...
                    stock.Symbol = symbol;
                    stock.Name = sa[3];
                    stock.PreviousClose = Decimal.Parse(sa[0]); //CHANGE THE INT BACK TO 0!!!
                    stock.LastTradePrice = Decimal.Parse(sa[1]);
        ...
        public static StockQuote GetStock(String symbol, DateTime date)
        {
            ...
            try
            {
                ...
                using (StreamReader stReader = new StreamReader(response.GetResponseStream()))
                {
                    ...
                    stock.PreviousClose = Decimal.Parse(sa[4]);
                    stock.LastTradePrice = Decimal.Parse(sa[6]);
